                  ...
                  <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-2.5">
                        ...
                        {fee && (
                          <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold ${free ? 'bg-emerald-50 text-emerald-700' : 'bg-slate-100 text-slate-700'}`}>
                    ...
                    <div className="flex flex-col items-stretch md:items-end justify-center gap-2 flex-shrink-0">
                      ...
                      {hasInfoSession && (
                        <button type="button" onClick={() => setInfoSessionEvent(event)}
                          className="px-4 py-2.5 rounded-xl font-bold text-[12px] whitespace-normal text-center flex items-center justify-center gap-1.5 bg-gradient-to-r from-brand-500 to-purple-600 hover:from-brand-600 hover:to-purple-700 text-white transition-all shadow-sm hover:-translate-y-0.5">
                          <Video className="w-3.5 h-3.5 flex-shrink-0" /> Join the Info Session for this event!
                        </button>
                      )}
                    </div>
                  </div>
